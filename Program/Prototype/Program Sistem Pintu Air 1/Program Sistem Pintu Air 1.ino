...
#define TINGGI_MAX 6 // Ubah sesuai dengan tinggi maksimum dari dasar ke sensor (cm)
...
void loop() {
  ...
  soilMoistureValue = constrain(soilMoistureValue, 0, 10); // Pastikan tetap dalam rentang 0-10
